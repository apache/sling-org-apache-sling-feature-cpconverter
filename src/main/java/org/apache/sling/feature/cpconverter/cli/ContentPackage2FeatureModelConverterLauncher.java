...
public final class ContentPackage2FeatureModelConverterLauncher implements Runnable {
    ...
    @Option(names = { "--enforce-servicemapping-by-principal" }, description = "Converts service user mappings with the form 'service:sub=userID' to 'service:sub=[principalname]'.", required = false)
